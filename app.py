...
def add_portfolio():
    ...
    item = PortfolioItem(
        ...
        subCategory=d.get('subcategory') or d.get('subCategory'), 
        thumbnail=d.get('thumbnail'),
        videoUrl=d.get('videoUrl'), 
        ytId=d.get('ytId'), 
        driveId=d.get('driveId'),
        description=d.get('desc') or d.get('description'), 
        date=d.get('date'), 
        size=d.get('size', 'normal')
    )
    db.session.add(item)
    db.session.commit()
...
def handle_portfolio_item(item_id):
    ...
    item.subCategory = d.get('subcategory') or d.get('subCategory') or item.subCategory
    ...
    item.description = d.get('desc') or d.get('description') or item.description
